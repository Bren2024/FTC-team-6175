...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="Autonomous Right Building", group="Pushbot")
//@Disabled

//v. 1.2
public class AutonomousRightBuilding extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.rightDrive.setPower(.6375);
        runtime.reset();
        while (opModeIsActive() && (runtime.seconds() < 2.67)) {
            Color.RGBToHSV(colorSensor.red(), colorSensor.green(), colorSensor.blue(), hsvValues);
